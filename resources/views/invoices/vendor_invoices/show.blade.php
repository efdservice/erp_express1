...
<div style="position: relative;min-height: 100%;height: 100%;">
    <table width="100%" style="font-family: sans-serif;">
        ...
        <tr style="text-align: center;">
            <td colspan="3"><h4 style="margin-bottom: 15px;margin-top: 25px;font-size: 14px;border-bottom: 1px solid #000;border-top: 1px solid #000;padding: 7px 0px;">Vendor Invoice</h4></td>
        </tr>
    </table>
    <table width="100%" style="font-family: sans-serif; margin-top: 20px;font-size: 12px">
        <tr>
            <td style="padding: 3px;width: 65%;text-align: left;"><strong>Vendor Name:</strong>:
                {{ \Illuminate\Support\Facades\DB::table("vendors")->selectRaw('CONCAT(name) AS rider_name')->value('rider_name') }}</td>
        ...
        <tr>
            <td style="padding: 3px;width: 65%;text-align: left;"><strong>Invoice Type</strong>: Vendor Invoice</td>
    ...
    <table style="width: 100%; font-family: sans-serif;text-align: center;border: 1px solid #000; border-collapse: collapse; margin-top: 20px;font-size: 12px;">
        ...
        <tbody>
        @php $total=0; @endphp
        @foreach($res[0]->vendorInv_item as $key=>$val)
