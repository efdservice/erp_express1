<div class="modal fade" id="change-rider">
    <div class="modal-dialog modal-xl">
        <div class="modal-content rounded-0">
            <form id="rider-form">
                <input type="hidden" name="sim_id" value="0">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <select class="form-control form-control-sm warehouse select2" name="status" id="status" onchange="bike_status()">
                                {!! App\Helpers\CommonHelper::get_sim_status() !!}
                            </select>
                        </div>
                        <div class="col-md-4 form-group" id="rider_select">
                            <label>Change Rider</label>
                            <select class="form-control form-control-sm select2" name="assign_sim" id="rider_change">
