        ...
        <div class="modal-content">
            <form id="upload-excel" method="post" enctype="multipart/form-data">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Upload Rta Fine
                        <a style="font-size: 12px;" href="{{ URL::asset('public/excel_samples/rta_fine.xlsx') }}" download>Download Sample</a> </h5>
