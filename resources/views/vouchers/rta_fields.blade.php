...
<div class="form-group col-md-2">
    ...
    <input type="text" name="toll_gate" class="form-control form-control-sm" placeholder="Toll Gate" value="@isset($vouchers->toll_gate){{$vouchers->toll_gate}} @endisset">
</div>
<div class="form-group col-md-2">
    <label>Trip Date</label>
    {{ Form::input('dateTime-local', 'trip_date',@$vouchers->trip_date, array('class' => 'form-control form-control-sm')) }}
</div>
<div class="form-group col-md-3">
    <label>Direction</label>
    <input type="text" name="direction" class="form-control form-control-sm" value="@isset($vouchers->direction){{$vouchers->direction}} @endisset">
</div>
...
<div id="fetchRiderInv" class="bg-white">
    ...
    @foreach($data as $entry)
            ...
            <div class="row">
               ...
               @if($entry->dr_cr == 1)
                <div class="form-group col-md-2">
                    <input type="number" name="amount[]" value="{{$entry->amount}}" class="form-control form-control-sm" placeholder="Paid Amount">
                </div>
                @endif
                @if($entry->dr_cr == 2)
                <div class="form-group col-md-2">
