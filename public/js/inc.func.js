...
function pagination(
    ...
    if (cur_page >= 5) {
        ...
        start_loop = 1;
        if (no_ofPage > 5) end_loop = 5;
        else end_loop = no_ofPage;
    }
    var htmlData = "";
    htmlData +=
    ...
    for (i = start_loop; i <= end_loop; i++) {
        if (i == cur_page) {
            htmlData +=
                '<li class="page-item active"><a class="page-link" onclick="get_data(' +
                i +
                ", '" +
                id +
                "')\">" +
            ...
            htmlData +=
                '<li class="page-item"><a class="page-link" onclick="get_data(' +
                i +
                ", '" +
                id +
                "')\">" +
    ...
    htmlData +=
        '<li class="page-item">' +
        '<a class="page-link" onclick="get_data(' +
        no_ofPage +
        ')" aria-label="Next">' +
...
function number_format(num) {
    if (num == "null") {
        ...
        var numb = Number(num).toLocaleString("en-US", {
