...
// Will either generate an <a> tag or a non-clickable <span> tag, depending on enabled Setup.
...
function buildViewDef(viewType, hash, defaultConfigs, overrideConfigs) {
    ...
    if (!theClass) {
        return null; // don't throw a warning, might be Setup for a single-unit view
    }
    return {
        type: viewType,
        class: theClass,
...
var Calendar = /** @class */ (function () {
    ...
    */
    ...
    // `Setup` is for formatter AND isEndExclusive
...
function formatRange(startInput, endInput, settings // mixture of env and formatter Setup
) {
