...
//            }
    ...
    public function assign_price_edit($id, $VID)
    {
        $data = DB::table("vendor_item_prices")->join("rider_item_prices", "vendor_item_prices.RID", "rider_item_prices.id")
            ->select(
                "vendor_item_prices.item_id AS item_id",
                "vendor_item_prices.VID AS VID",
                "vendor_item_prices.price as vp",
                "rider_item_prices.price as rp",
                "rider_item_prices.RID as RRID",
                "rider_item_prices.price as rider_price",
                "vendor_item_prices.price as vendor_price"
            )
